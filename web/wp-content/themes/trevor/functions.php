...
function remove_p_on_empty($content) {
    if ( is_page_template( 'page-templates/empty.php' ) || is_page_template( 'page-templates/prideeverywhere.php' ) || is_page_template( 'page-templates/technology.php' ) || is_page_template( 'page-templates/RTLR.php' ) ) {

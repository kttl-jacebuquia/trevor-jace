...
class OptionLicenses extends WpSolrExtensions {
	...
	static function ajax_activate_licence() {
		...
		$subscription_number        = isset( $_POST['data'] ) && isset( $_POST['data'][ self::FIELD_LICENSE_SUBSCRIPTION_NUMBER ] ) ? sanitize_text_field( $_POST['data'][ self::FIELD_LICENSE_SUBSCRIPTION_NUMBER ] ) : null;
		$license_package            = isset( $_POST['data'] ) && isset( $_POST['data'][ self::FIELD_LICENSE_PACKAGE ] ) ? sanitize_text_field( $_POST['data'][ self::FIELD_LICENSE_PACKAGE ] ) : null;
		$license_matching_reference = isset( $_POST['data'] ) && isset( $_POST['data'][ self::FIELD_LICENSE_MATCHING_REFERENCE ] ) ? sanitize_text_field( $_POST['data'][ self::FIELD_LICENSE_MATCHING_REFERENCE ] ) : null;
